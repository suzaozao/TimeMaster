...
//配置ESP8266WIFI设置
#define SSID "srabc"    //填写2.4GHz的WIFI名称，不要使用校园网
#define PASSWORD "12345678"//填写自己的WIFI密码
#define HOST_NAME "api.heclouds.com"  //API主机名称，连接到OneNET平台，无需修改
#define DEVICE_ID "643460897"       //填写自己的OneNet设备ID
#define HOST_PORT (80)                //API端口，连接到OneNET平台，无需修改
String APIKey = "mKOBSfApxsA1cnpa2ISTsGQ6YY0="; //与设备绑定的APIKey
...
void loop(){
  float n = (float)analogRead(A3);   //读取模拟口A3，获取光强
    Serial.println(n);
